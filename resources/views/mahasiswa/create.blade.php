    ...
    <form action="{{ route('admin.mahasiswa.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" name="nim" class="mt-1 p-2 block w-full border border-gray-300 rounded-lg shadow-sm" placeholder="NIM" required>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">No HP</label>
                <input type="number" name="no_hp" class="mt-1 p-2 block w-full border border-gray-300 rounded-lg shadow-sm" placeholder="No HP">
            </div>
            <div>
