    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('sellectallAllbutton').addEventListener('click', function() {
                ...
                // const allChecked = Array.from(checkboxes).every(checkbox => checkbox.checked); // Check if all checkboxes are checked

                // Toggle the checked state of all checkboxes
                checkboxes.forEach(function(checkbox) {
                    checkbox.checked = true; // If all are checked, uncheck them; otherwise, check them
                });

                // Call filterAlumni to update the display based on the current filters
                filterAlumni();
            });
