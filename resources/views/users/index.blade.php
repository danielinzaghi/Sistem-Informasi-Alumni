<x-app-layout>
    ...
    <div class="flex justify-between items-center mb-2">
        <h1 class="font-semibold text-md sm:text-2xl">Data Pengguna</h1>
        <button
            type="button"
            class="create-user-btn text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs sm:text-sm px-3 sm:px-5 py-1.5 sm:py-2.5 me-2 focus:outline-none">Tambah</button>  
    </div>
                ...
                @if ($data != Auth::user())
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-2 text-center py-4 flex justify-center items-center">
                            ...
                            <button data-id ="{{ $data->id }}" type="button" class="edit-user-btn text-yellow-400 border border-yellow-400 hover:bg-yellow-400 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-xs sm:text-sm p-2 text-center inline-flex items-center me-2">
                    ...
                    success: function(response) {
                        ...
                        if (response && response.roles) {
                            ...
                            if (roleName === 'mahasiswa') {
                                ...
                                console.log('id prodi ' + response.mahasiswa.id_prodi);
