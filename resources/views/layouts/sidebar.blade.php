        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a
                    ...
                    <span class="ms-1 text-xs font-light">Berita</span>
                </a>
            </li>
            @role('alumni')
            <li>
            ...
            @role('admin')
                ...
                <li>
                    <a
                        class="flex items-center p-2 rounded-md shadow-md transition-all {{ setActive('admin.ArticleIndex') }}"
                ...
                <li>
                    <a
                        ...
                        href="{{ route('admin.tracer_study.index') }}">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
