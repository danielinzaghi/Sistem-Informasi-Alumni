<aside
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto">
        <ul class="space-y-2 font-medium">
            <li>
                <a
                    class="flex items-center p-2 rounded-md shadow-md transition-all {{ setActive(Auth::user()->roles->first()->name . '.dashboard') }}"
                    ...
                    <span class="ms-1 text-xs font-light">Dashboard</span>
                </a>
            </li>
            <li>
                <a
                    class="flex items-center p-2 rounded-md shadow-md transition-all {{ setActive(Auth::user()->roles->first()->name . '.tracer_study.*') }}"
                    @role('alumni') href="{{ route('alumni.tracer_study.show', Auth::user()->alumni->tracerStudy->id) }}"  @else href="{{ route(Auth::user()->roles->first()->name . '.tracer_study.index') }}" @endrole>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
            ...
            <li>
                <a
                    class="flex items-center p-2 rounded-md shadow-md transition-all {{ setActive('alumni.tracer_study.*') }}"
                    href="{{ route('alumni.tracer_study.index') }}">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
            ...
            <li>
                <a
                    ...
                    <span class="ms-1 text-xs font-light">Kategori Artikel</span>
            ...
            <li>
                <a
                    class="flex items-center p-2 rounded-md shadow-md transition-all {{ setActive(Auth::user()->roles->first()->name . '.article.*') }}"
                    href="{{ route(Auth::user()->roles->first()->name . '.article.index') }}">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <span class="ms-1 text-xs font-light">Artikel</span>
            ...
            <li>
                <a
                    ...
                    <span class="ms-1 text-xs font-light">Users</span>
                </a>
            </li>
            <li>
                <a
